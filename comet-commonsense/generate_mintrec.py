...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="atomic")
    parser.add_argument("--relation", type=str, default="all")
    parser.add_argument("--input_file", type=str, default="inputs/test.tsv")
    parser.add_argument("--output_file", type=str, default="outputs/test_out.csv")
